...
/**
 *
 * A Component interface – what the object can do.
 * A ConcreteComponent – the basic implementation.
 * A Decorator base class – implements the same interface and holds a reference to a Component.
 * One or more ConcreteDecorators – extend the decorator base class, add behavior before/after delegating to the wrapped component.
 *
 *
 *
