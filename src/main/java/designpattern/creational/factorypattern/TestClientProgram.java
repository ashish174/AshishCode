...
public class TestClientProgram {
  ...
  public static void main(String[] args) {
    try{
      Computer computer1 =  ComputerFactory.getComputer(ComputerType.PC, "4GB", "120GB", "4GHz");
      Computer computer2 = ComputerFactory.getComputer(ComputerType.SERVER, "10GB", "200GB", "10GHz");
    ...
    } catch (InvalidComputerTypeException e) {
