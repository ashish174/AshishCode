package algo.practice.a_neetcode150.slidingwindow;
 ...
 * A string is called valid if none of its substrings are present in forbidden list.
 ...
 * The length of the longest valid substring is 4 (aabc).
 ...
 * The length of the longest valid substring is 4 (tcod).
